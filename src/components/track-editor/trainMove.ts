...
// import { BranchDirection, DetailedTimetable, Operation, Point, Track, Train } from '../../model.js';
// import {
//   getDistance,
//   getMidPoint,
...
//   tick(globalTimeManager: GlobalTimeManager, moneyManager: MoneyManager, tracks: Track[]): void {
//     this.placeTrainFromPlatformTimetable(globalTimeManager);
//     this.trainMove.tick({ globalTimeManager, moneyManager, tracks });
